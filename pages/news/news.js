...
Page({
  ...
  data: {
    page: 0,
    list: [
      { id: 0, 'type': 'all', name: '头条', storage: [], url: 'get_newslist.php', enabeld: { guest: true, student: true, teacher: true}},
      { id: 1, 'type': 'jw', name: '教务头条', storage: [], url: 'news/jw_list.php', enabled: { guest: true, student: true, teacher: true}},
      { id: 2, 'type': 'jz', name: '学术讲座', storage: [], url: 'news/jz_list.php', enabled: { guest: true, student: true, teacher: true } },
      { id: 3, 'type': 'new', name: '综合新闻', storage: [], url: 'news/new_list.php', enabled: { guest: true, student: true, teacher: true } },
      { id: 4, 'type': 'oa', name: 'OA公告', stroage: [], url: 'news/oa_list.php', enabled: { guest: true, student: true, teacher: true }},
      { id: 5, 'type': 'hy', name: '会议通知', storage: [], url: 'news/hy_list.php', enabled: { guest: true, student: true, teacher: true }}
    ],
    'active': {
      id: 0,
      'type': 'all',
